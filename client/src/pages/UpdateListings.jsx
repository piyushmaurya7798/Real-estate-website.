...
()=>{
  ...
  return (
    ...
    <div className='flex flex-col gap-4 flex-1'>
        <input type="text" placeholder='Name' className='border p-3 rounded-lg' onChange={handleChange} value={formData.name} id='name' maxLength='62' minLength='10' required/>
        ...
        <div className='flex flex-wrap gap-6'>
            <div className='flex gap-2'><input type="checkbox" id='sell' className='w-5' onChange={handleChange} checked={formData.type === "sell"}/><span>Sell</span></div>
        ...
        <div className='flex flex-wrap gap-6'>
            ...
            <div className='flex items-center gap-2'>
                <input className='p-3 border border-gray-300 rounded-lg' type='number' id='discountedPrice' min='0' max='1000000' required onChange={handleChange} value={formData.discountedPrice}/>
                <div className='flex flex-col item-center'>
    ...
    <div className='flex flex-col flex-1 gap-4'>
        ...
        <div className='flex gap-4'>
            ...
            <button type="button" disabled={uploading} onClick={handleImageSubmit}className='p-3 text-green-700 border border-green-700 rounded-lg uppercase hover:shadow-lg disabled:opacity-80'>{uploading ? 'Uploading...': 'Upload'}</button>
        </div>
...
<button onClick={()=>handleRemoveImage(index)}  type="button" className="p-3 text-red-700 rounded-lg uppercase hover:opacity-75">Delete</button>
    ...
    <button disabled={loading || uploading} className='p-3 bg-slate-700 text-white rounded-lg uppercase hover:opacity-95 disabled:opacity-80'>{ loading?'Updating Please wait...':'Update Listing'}</button>
